...
#ifndef ORBIT_LIFTOFF_CFGEN_H_
#define ORBIT_LIFTOFF_CFGEN_H_
...
namespace liftoff {
    class CFGGen : parser::ASTVisitor<CFGGen> {
    ...
    public:
        explicit CFGGen(orbiter::Isolate *isolate) : isolate_(isolate) {
        }

        void *BuildCFG(parser::ASTHandle<parser::Module *> &module);
    };
}

#endif // |ORBIT_LIFTOFF_CFGEN_H_
