...
namespace liftoff::parser {
    ...
    inline ASTHandle<Unary *> MakeUnary(const scanner::Loc &loc, NodeType node_type) {
        assert(
            node_type == NodeType::AWAIT || node_type == NodeType::ELLIPSIS || node_type == NodeType::KW_ARG ||
            node_type == NodeType::NIL_SAFE || node_type == NodeType::PANIC || node_type == NodeType::SPAWN || node_type
            == NodeType::TRAP || node_type == NodeType::UNARY || node_type == NodeType::UPDATE);
