...
inline void ASTNodeCleanup(ASTNode* ast_node) {
    ...
    switch (ast_node->node_type) {
        ...
        Release(node->literal);
                break;
            }         case NodeType::FOR:         case NodeType::FOR_IN:         case NodeType::LOOP:         {
        ...
        if (node->step)
            ASTNodeCleanup(node->step);
                break;
            }         case NodeType::AWAIT:         case NodeType::CHAN_RECV:         case NodeType::DEFER:         case NodeType::ELLIPSIS:         case NodeType::KW_ARG:         case NodeType::NIL_SAFE:         case NodeType::PANIC:         case NodeType::RETURN:         case NodeType::SPAWN:         case NodeType::TRAP:         case NodeType::UNARY:         case NodeType::UPDATE:         {
...
inline ASTHandle<Unary*> MakeUnary(const scanner::Loc &loc, NodeType node_type) {
    assert(node_type == NodeType::AWAIT || node_type == NodeType::CHAN_RECV || node_type == NodeType::DEFER || node_type == NodeType::ELLIPSIS || node_type == NodeType::KW_ARG || node_type == NodeType::NIL_SAFE || node_type == NodeType::PANIC || node_type == NodeType::RETURN || node_type == NodeType::SPAWN || node_type == NodeType::TRAP || node_type == NodeType::UNARY || node_type == NodeType::UPDATE);
